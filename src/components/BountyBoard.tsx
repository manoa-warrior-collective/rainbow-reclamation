...
export const useBountyBoard = (): BountyBoardHook => {
  ...
  const filteredItems = items.filter((item) => {
    ...
    const matchesBounty = !filters.showBountyOnly || item.bountyStatus;

    return matchesSearch && matchesCategory && matchesBuilding && matchesBounty;
  });
